    ...
    for (let i = 0; i < 10; i++) {
      if (val >= 1 && val <= 250000) {
        ...
        return setValue(salary- val)
         ...
         val = 37000 + 12500 + 25000
         setTax(val)
        return setValue(salary- val)

      } else if (val > 1000000 && val <= 1250000) {
         val = 50000 + 12500 + 25000 + 37000
         setTax(val)
        return setValue(salary- val)

      } else if (val > 1250000 && val <= 1500000) {
         val = 62500 + 12500 + 25000 + 37000 + 50000
         setTax(val)
        return setValue(salary- val)
          ...
          <div className='left-part'>
            ...
            <div className='calculate'>
              ...
              <div style={{marginBottom:"20px"}}>
                ...
                <p>Taxable income: {" "}R{salary}</p>
                <p>Tax = 7% of taxable income exceeding R91 250</p>
                <p>Tax={" "}{tax}</p>
                <p>Profit after tax:{" "}R{value}</p>
              </div>
