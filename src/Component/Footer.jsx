          ...
          <SimpleGrid
            ...
            <Stack spacing={6}>
              ...
              <Stack direction={'row'} spacing={6}>
                <SocialButton label={'Twitter'} href={'https://twitter.com/intent/tweet?text=Tax%20Calculators%20%7C%20TaxTim%20SA&url=https%3A%2F%2Fwww.taxtim.com%2Fza%2Fcalculators%2F%23.ZFKpIUrzyDc.twitter&related='}>
                  <FaTwitter />
                </SocialButton>
                <SocialButton label={'YouTube'} href={'https://www.bing.com/videos/riverview/relatedvideo?&q=taxtim+youtube&qpvt=taxtim+youtube&mid=08F441C97AE6C230C69408F441C97AE6C230C694&&FORM=VRDGAR'}>
                  <FaYoutube />
                </SocialButton>
                <SocialButton label={'Instagram'} href={'https://www.instagram.com/taxtim_za/'}>
                  <FaInstagram />
                </SocialButton>
              </Stack>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>About TaxGenius</ListHeader>
              <Link href={'/about'}>About us</Link>
              <Link href={'#'}>Blog</Link>
              <Link href={'#'}>Contact us</Link>
              <Link href={'#'}>Refund Policy</Link>
              <Link href={'#'}>Job at TaxGenius</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>TaxGenius Support</ListHeader>
